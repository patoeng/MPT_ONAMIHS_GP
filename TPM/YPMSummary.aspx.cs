...
namespace TPM
{
    public partial class YPMSummary : System.Web.UI.Page
    {
        ...
        protected void prepare()
        {
            ...
            DataSet ds = SqlHelper.ExecuteDataset(TPMHelper.DBTPMstring, CommandType.StoredProcedure,
                                                  "usp_MDepartmentsSelect");
           ...
           //   ds = SqlHelper.ExecuteDataset(TPMHelper.DBTPMstring, CommandType.Text,
          //                                "select id,descriptions from mpmstatus");
           ...
           /* if (ds.Tables.Count > 0)
            ...
            if (m != "")
            {
                ...
                ds = SqlHelper.ExecuteDataset(TPMHelper.DBTPMstring, CommandType.StoredProcedure,
                                              "usp_summary_MPMSchedulesSelect", sqlparams.ToArray());
