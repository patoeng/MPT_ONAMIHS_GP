...
namespace TPM
{
    public partial class YIWOAttachments : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                lblTittle.InnerHtml = "Improvement Work Order Attachments, for IWOID=#" + _iwokey;
                ShowAttachment();
                if (_status > 6)
                {
        ...
        private void ShowAttachment()
        {
            ...
            var dss = SqlHelper.ExecuteDataset(TPMHelper.DBTPMstring, CommandType.StoredProcedure,
                                                       "usp_IWOAttachmentsSelect", new SqlParameter("@iwokey", _iwokey));
            var dt = dss.Tables[0];
        ...
        protected void Submit1_ServerClick(object sender, EventArgs e)
        {
            ...
            if ((File1.PostedFile != null) && (File1.PostedFile.ContentLength > 0))
            {
                ...
                try
                {
                    string fn = "AT_" + DateTime.Now.ToString("yyyyddMMHHmmss") + extenstion;
                    saveLocation += fn;
                    ...
                    var sqlparams = new List<SqlParameter>
                        {
                            new SqlParameter("@iwokey", _iwokey),
                    ...
                    var dss = SqlHelper.ExecuteDataset(TPMHelper.DBTPMstring, CommandType.StoredProcedure,
                                                       "usp_IWOAttachmentsInsert", sqlparams.ToArray());
        ...
        {
            Response.Redirect("YIWorkOrders.aspx?v="+_iwokey);
        }
    }
}