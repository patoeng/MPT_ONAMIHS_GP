...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContentHolder" runat="server">
    ...
    <div class="row-fluid">
        <div class="span11">
            <h4 id="lblCat">Spare Part Replacement WO ID : #<a href="/<%=TPMHelper.WebDirectory%>/Yworkorders.aspx?v=<%=WOId %>" target="_self"><%=WOId %></a></h4>
             <hr />
       ...
       $(document).ready(function () {
           ...
           $('.tombol').click(function (event) {
               ...
               $.ajax({
                   ...
                   contentType: "application/json; charset=utf-8",
                   dataType: "json",
                   data: JSON.stringify({ woid: woid, code: ssData, qty: ssQty, act: action, reason: ssReason, name: ssName, price :ssPrice, currency:ssCurrency }, null, 2),
                   success: function (json) {
