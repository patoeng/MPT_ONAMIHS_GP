    ...
    <div class="row-fluid">
     ...
     <div class="row-fluid">
         <div class="container-fluid">
                    <div class="span8"><h4>Latest Status</h4><hr />
             ...
             <div class="span4">
                 <div class="row-fluid" style="display:<%= status_id < 4 ? "none":"block"%>">
                     <div class="span12" ><hr /><h3 ><a href="/<%=TPMHelper.WebDirectory%>/YChecklist.aspx?id=<%= lid2.ToString(CultureInfo.InvariantCulture) %>" class="btn btn-primary link">Checklist</a></h3></div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="FooterScriptsHolder" runat="server">
    <script type="text/javascript">
        ...
        var pid = '<%= schedule_id_true.ToString() %>';
        var lid = '<%= lid.ToString(CultureInfo.InvariantCulture) %>';
        var date2 ="<%= sched %>";
        ...
        $('.tombol').click(function () {
            ...
            if (action == "btnRemarks") {
                ...
                ajaxAction(pid, action, "test", date2, function (objs) {
                    ...
                    if (objs == "0") {
                        alert("PM Checklist un-filled yet!");
                    } else {
                        window.location.reload();
                    }
        ...
        $('.text_editable').editable('./Methodes/pm.asmx/Jeditable', {
            ...
            intercept: function (jsondata) {
                try {
                    var obj = jQuery.parseJSON(jsondata); // do something with obj.status and obj.other{
                   // $(".text_editable").text(obj.d)
                    return (obj.d);
                } catch (err) {
                    alert(err.message);
                }
        ...
        $('.editable').editable('./Methodes/pm.asmx/Jeditable', {
            indicator: "<img src='./Images/indicator.gif'>",
            onblur: 'submit',
            submit: "OK",
            cancel: "Cancel",
        ...
        $('.editable2').editable('./Methodes/pm.asmx/Jeditable', {
            indicator: "<img src='./Images/indicator.gif'>",
            onblur: 'submit',
            submit: "OK",
            cancel: "Cancel",
