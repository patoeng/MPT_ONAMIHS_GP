...
exec ('c:\\PROGRA~1\\iecapt\\IECapt.exe --url="http://localhost/print.php?batchid='.$batchid.'" --out="c:\\logger\\batches\\Batch'.$batchid.'.bmp"',$ar);
chdir('phpxls');
...
$j=5;
$askjoin = " SELECT batchmodel.model as SAP, model.description as Model, batchmodel.qty AS QTY \n
             FROM batchmodel \n
			 INNER JOIN model \n
