<%@ Page Title="" Language="C#" MasterPageFile="~/TPM.Master" AutoEventWireup="true" CodeBehind="yiwosummary.aspx.cs" Inherits="TPM.yiwosummary" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContentHolder" runat="server">
    ...
    <div class="row-fluid">
        <div class="span12" style="text-align:center">
             ...
             <h3>Improvement Work Order Summary</h3>
    ...
    <script type="text/javascript">
        ...
        $('#form1').validate({
            submitHandler: function () {
                ...
                $.ajax({
                    url: './Methodes/iwo.asmx/summary',
                    cache: false,
                    type: 'POST',
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    data: JSON.stringify({ isdownload: isdownload, department: $('#Department option:selected').val(), status_id: $('#status_id option:selected').val(), startdate: $('#startdate').val(), enddate: $('#enddate').val(), req_type: $('#adhoc option:selected').val() }, null, 2),
