(function( $ ){
	...
	*/
	$.fn.fileReader.defaults = {
		...
		label           : "CSV files (.csv)",
		extensions      : '*.csv',
		filereader      : './Scripts/swf/filereader.swf', // The path to the filereader swf file
		expressInstall  : './Scripts/swf/expressInstall.swf', // The path to the express install swf file
		debugMode       : false,
