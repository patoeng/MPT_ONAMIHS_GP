    ...
    public partial class ASMODAttribute : System.Web.UI.Page
    {
        ...
        protected void prepare(){
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                for (int h = 0; h < 2; h++)
                {
                    ...
                    for (i = 0; i < dt.Columns.Count; i++)
                    {
                        ...
                        if (i >=3)
                        {
                            ...
                            htmTag.Attributes.Add("href", "/TPM/Mchecklist.aspx?m=p&id=" + dr[i].ToString());
                            //pre
                    ...
                    htmTag = new HtmlGenericControl("a");
                            htmTag.InnerHtml = "View";
                            htmTag.Attributes.Add("href", "/TPM/Ycrud.aspx?table=MCheckLists&d=AssetModel_Id&v=" + dr[0].ToString());
                            //pre
                    ...
                    htmTag = new HtmlGenericControl("a");
                            htmTag.InnerHtml = "View";
                            htmTag.Attributes.Add("href", "/TPM/Ycrud.aspx?table=MListItems&d=checklist_Id&v=" + dr[i-2+h].ToString());
                            //pre
                    ...
                    htmTag = new HtmlGenericControl("a");
                    htmTag.InnerHtml = "View";
                    htmTag.Attributes.Add("href", "/TPM/YCheckListImg.aspx?i=" + dr[3 + h].ToString());
                    //pre
                ...
                htmTag = new HtmlGenericControl("a");
                htmTag.InnerHtml = "View";
                htmTag.Attributes.Add("href", "/TPM/YMBOMS.aspx?a=" + dr[0].ToString());
                //pre
                tc = new TableCell();
                tc.Controls.Add(htmTag);
