<%@ Page Title="" Language="C#" MasterPageFile="~/TPM.Master" AutoEventWireup="true" CodeBehind="MChecklist.aspx.cs" Inherits="TPM.MChecklist" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContentHolder" runat="server">
   ...
   <div class="row-fluid">
        ...
        <div style="<%= checklist_exist==false? "display:none":"" %>">
    <div class="row-fluid">
    ...
    <div class="row-fluid">
            <div class="span6"><asp:Table ID="TblImage" ClientIDMode="Static" cssClass="table table-bordered" runat="server"></asp:Table></div>
            <div class="span6"><asp:Table ID="TblListItems" ClientIDMode="Static" cssClass="table table-striped table-bordered" runat="server"></asp:Table></div>
        </div>
    <div class="row-fluid">
    ...
    <script type="text/javascript">
        ...
        $('.btn').click(function (event) {
            ...
            if (id == "btnImg") {
                ...
                window.location = "/TPM/YCheckListImg.aspx?i=" + $('#selectChecklist').val();
                return true;
            }
            $.ajax({
